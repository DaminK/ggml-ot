...
def ShuffleSplit(labels,n_splits=10,train_size=0.4,test_size=0.4,validation_size=0.2,distribution_labels=None):
...
def knn_from_dists(dists, labels, n_splits=20, distribution_labels=None, n_neighbors=5,weights=None,test_size=0.2,train_size=None):
    predicted_labels, true_labels, test_indices, scores = [],[],[],[]

    train_test_inds = ShuffleSplit(labels,n_splits,train_size,test_size,validation_size=0,distribution_labels=distribution_labels)
